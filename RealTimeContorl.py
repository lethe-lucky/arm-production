...
def main(args=None):
    ...
    follower_temperature = [0.0 for i in range(len(servo_ids))]
    while True:
        ...
        for id in servo_ids: 
            ...
            follower_temperature[id] = follower_control.servos[id].temp
        ...
        time.sleep(0.005)
        print(f"follower温度(°C, id=6): {follower_temperature[6]:.1f}")
